...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attribute.choices_str'
        db.add_column('users_attribute', 'choices_str',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ContractorAttributeVal.choices_str'
        db.delete_column('users_contractorattributeval', 'choices_str')

    def backwards(self, orm):
        # Deleting field 'Attribute.choices_str'
        db.delete_column('users_attribute', 'choices_str')

        # Adding field 'ContractorAttributeVal.choices_str'
        db.add_column('users_contractorattributeval', 'choices_str',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)
