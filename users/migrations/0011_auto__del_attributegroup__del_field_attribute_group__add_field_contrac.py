...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContractorAttributeVal.char_val'
        db.add_column('users_contractorattributeval', 'char_val',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Attribute.group'
        raise RuntimeError("Cannot reverse this migration. 'Attribute.group' and its values cannot be restored.")
        # Deleting field 'ContractorAttributeVal.char_val'
        db.delete_column('users_contractorattributeval', 'char_val')
    ...
    models = {
        ...
        'users.contractorattributeval': {
            ...
            'char_val': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
