...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientContactInfo.is_primary'
        db.add_column('users_clientcontactinfo', 'is_primary',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Client.primary_contact'
        db.delete_column('users_client', 'primary_contact_id')

    def backwards(self, orm):
        # Deleting field 'ClientContactInfo.is_primary'
        db.delete_column('users_clientcontactinfo', 'is_primary')

        # Adding field 'Client.primary_contact'
        db.add_column('users_client', 'primary_contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=False, related_name='primary_contact', to=orm['users.ClientContactInfo']),
                      keep_default=False)
