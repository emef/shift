...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contractor.lat'
        db.alter_column('users_contractor', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Contractor.lng'
        db.alter_column('users_contractor', 'lng', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # Changing field 'Contractor.lat'
        db.alter_column('users_contractor', 'lat', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Contractor.lng'
        db.alter_column('users_contractor', 'lng', self.gf('django.db.models.fields.FloatField')(default=0))
    models = {
        'auth.group': {
