...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_contractor', 'location', self.gf('django.db.models.fields.CharField')(max_length=200))
    def backwards(self, orm):

        # Changing field 'Contractor.location'
        db.alter_column('users_contractor', 'location', self.gf('shift.location.LocationField')(max_length=100))
    models = {
        'auth.group': {
