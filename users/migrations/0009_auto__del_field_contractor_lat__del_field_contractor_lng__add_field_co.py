...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contractor.lat'
        db.delete_column('users_contractor', 'lat')

        # Deleting field 'Contractor.lng'
        db.delete_column('users_contractor', 'lng')

        # Adding field 'Contractor.location'
        db.add_column('users_contractor', 'location',
                      self.gf('shift.location.LocationField')(max_length=300, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Contractor.lat'
        db.add_column('users_contractor', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'Contractor.lng'
        db.add_column('users_contractor', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'Contractor.location'
        db.delete_column('users_contractor', 'location')
    ...
    models = {
        ...
        'users.contractor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('shift.location.LocationField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
