...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contractor.is_female'
        db.delete_column('users_contractor', 'is_female')

        # Adding field 'AttributeSet.sex'
        db.add_column('users_attributeset', 'sex',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Contractor.is_female'
        db.add_column('users_contractor', 'is_female',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AttributeSet.sex'
        db.delete_column('users_attributeset', 'sex')
    ...
    models = {
        ...
        'users.attributeset': {
            ...
            'bust_chest': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'hair_length': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
