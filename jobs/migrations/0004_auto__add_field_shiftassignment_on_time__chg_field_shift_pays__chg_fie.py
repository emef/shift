...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShiftAssignment.on_time'
        db.add_column('jobs_shiftassignment', 'on_time',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Shift.pays'
        db.alter_column('jobs_shift', 'pays', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'Shift.lat'
        db.alter_column('jobs_shift', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Shift.lng'
        db.alter_column('jobs_shift', 'lng', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):
        # Deleting field 'ShiftAssignment.on_time'
        db.delete_column('jobs_shiftassignment', 'on_time')


        # Changing field 'Shift.pays'
        db.alter_column('jobs_shift', 'pays', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))

        # Changing field 'Shift.lat'
        db.alter_column('jobs_shift', 'lat', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Shift.lng'
        db.alter_column('jobs_shift', 'lng', self.gf('django.db.models.fields.FloatField')(default=0))
    models = {
        'auth.group': {
