...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shift.role'
        db.add_column('jobs_shift', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.ContractorRole']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Shift.role'
        db.delete_column('jobs_shift', 'role_id')
