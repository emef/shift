...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.client'
        db.alter_column('jobs_job', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Client']))
    def backwards(self, orm):

        # Changing field 'Job.client'
        db.alter_column('jobs_job', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    models = {
        'auth.group': {
