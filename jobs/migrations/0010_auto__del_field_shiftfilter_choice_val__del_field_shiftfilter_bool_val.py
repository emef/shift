...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShiftFilter.choice_val'
        db.delete_column('jobs_shiftfilter', 'choice_val')

        # Deleting field 'ShiftFilter.bool_val'
        db.delete_column('jobs_shiftfilter', 'bool_val')

        # Adding field 'ShiftFilter.bool'
        db.add_column('jobs_shiftfilter', 'bool',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShiftFilter.choice'
        db.add_column('jobs_shiftfilter', 'choice',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ShiftFilter.choice_val'
        db.add_column('jobs_shiftfilter', 'choice_val',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShiftFilter.bool_val'
        db.add_column('jobs_shiftfilter', 'bool_val',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ShiftFilter.bool'
        db.delete_column('jobs_shiftfilter', 'bool')

        # Deleting field 'ShiftFilter.choice'
        db.delete_column('jobs_shiftfilter', 'choice')
