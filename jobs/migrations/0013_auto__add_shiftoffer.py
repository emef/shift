...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShiftOffer'
        db.create_table('jobs_shiftoffer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shift', self.gf('django.db.models.fields.related.ForeignKey')(related_name='offers', to=orm['jobs.Shift'])),
            ('contractor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='offers', to=orm['users.Contractor'])),
            ('available', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal('jobs', ['ShiftOffer'])

    def backwards(self, orm):
        # Deleting model 'ShiftOffer'
        db.delete_table('jobs_shiftoffer')
