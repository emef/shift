...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShiftOffer.available'
        db.delete_column('jobs_shiftoffer', 'available')

        # Adding field 'ShiftOffer.confirmed'
        db.add_column('jobs_shiftoffer', 'confirmed',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'ShiftOffer.available'
        db.add_column('jobs_shiftoffer', 'available',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ShiftOffer.confirmed'
        db.delete_column('jobs_shiftoffer', 'confirmed')
    ...
    models = {
        ...
        'users.client': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'clients'", 'null': 'True', 'to': "orm['users.Manager']"}),
