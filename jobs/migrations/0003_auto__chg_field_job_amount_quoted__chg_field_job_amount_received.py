...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.amount_quoted'
        db.alter_column('jobs_job', 'amount_quoted', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'Job.amount_received'
        db.alter_column('jobs_job', 'amount_received', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))
    def backwards(self, orm):

        # Changing field 'Job.amount_quoted'
        db.alter_column('jobs_job', 'amount_quoted', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))

        # Changing field 'Job.amount_received'
        db.alter_column('jobs_job', 'amount_received', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))
    models = {
        'auth.group': {
