...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('jobs_job', 'status', self.gf('django.db.models.fields.IntegerField')(max_length=100))
    def backwards(self, orm):

        # Changing field 'Job.status'
        db.alter_column('jobs_job', 'status', self.gf('django.db.models.fields.CharField')(max_length=100))
    models = {
        'auth.group': {
