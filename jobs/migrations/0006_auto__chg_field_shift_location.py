...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Shift.location'
        db.alter_column('jobs_shift', 'location', self.gf('shift.location.LocationField')(max_length=100, null=True))
    def backwards(self, orm):

        # Changing field 'Shift.location'
        db.alter_column('jobs_shift', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=250))
    models = {
        'auth.group': {
        ...
        'jobs.shift': {
            ...
            'location': ('shift.location.LocationField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
