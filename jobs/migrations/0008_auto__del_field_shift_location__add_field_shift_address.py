...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Shift.location'
        db.delete_column('jobs_shift', 'location')

        # Adding field 'Shift.address'
        db.add_column('jobs_shift', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Shift.location'
        db.add_column('jobs_shift', 'location',
                      self.gf('shift.location.LocationField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Shift.address'
        db.delete_column('jobs_shift', 'address')
